...
/*Событие load гарантирует, 
что браузер отображает страницу полностью: 
все стили и картинки готовы, 
размеры элементов на странице посчитаны верно и доступны.*/
window.addEventListener('load', function(){
	...
	slider.addEventListener('change', function(e){
		...
		// возвращаем значение обратно в html страницу
		showGameSpeed.innerHTML = gameSpeed;
	});
